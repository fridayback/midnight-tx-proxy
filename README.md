...
```json
{
  "preprod": {
    ...
    "indexerWS": "wss://indexer-preprod.midnight.network",
    "node": "https://node-preprod.midnight.network",
    "proofServer": "https://proof-server-preprod.midnight.network",
    "networkId": "preprod",
    "contractAddress": "0x...（请替换为实际的合约地址）",
    "zkConfigPath": "./node_modules/midnight-crosschain/dist/managed/crosschain/keys/",
    "serverPort": 3000,
